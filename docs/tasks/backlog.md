...
| 5 | TASK-005 | Add local regression smoke tests for launcher, workbench layout, settings, and diff rendering | CHANGES_REQUESTED | TASK-002 through TASK-004 (accepted) |
